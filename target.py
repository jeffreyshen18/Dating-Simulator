...
# The purpose of this file is to get the user's input for the probability of a X-type behaviour occuring during an interaction for Target
#and the probability of a Y-type behaviour occuring during an interaction for Target, implementing recursion to ensure that the probability is
#within range (0.1-1.0), and printing a report for the Target statistics at the end of the simulation.
...
class Target:
    ...
    def __init__(self):
        ...
        self.NumX = 0
        self.NumY = 0
    # This method takes the user's input for the probabilities of X-type behaviour and Y-type behaviour for the Target,
    ...
    def input(self):
        ...
        if (self.percentX + self.percentY) != 1.0:
            ...
            self.input()
    # This method generates a report for the total number of X-type behaviours and Y-type behaviours for Target after the simulation is run.
